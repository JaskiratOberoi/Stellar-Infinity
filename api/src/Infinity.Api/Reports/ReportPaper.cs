...
/// asked, resolved here into the three things the pipeline actually needs:
/// whether the letterhead artwork is composited, which page box the print
/// route lays out for, and where the page number sits.
/// </summary>
/// <remarks>
/// <list type="bullet">
/// <item><c>letterhead</c> — Noble's artwork composited into the PDF, for
/// plain paper and digital copies. 26/34mm margins.</item>
/// <item><c>noble</c> — NO artwork, the same 26/34mm: pre-printed Noble
...
/// <item><c>plain</c> — no artwork, 40/40mm: a client's own stationery, whose
/// header band is taller than Noble's.</item>
/// </list>
...
/// </remarks>
public readonly record struct ReportPaper(string Key, bool Artwork, double PageNumberY)
{
    public static readonly ReportPaper Letterhead = new("letterhead", Artwork: true, PageNumberY: 99);
    public static readonly ReportPaper Noble = new("noble", Artwork: false, PageNumberY: 99);
    public static readonly ReportPaper Plain = new("plain", Artwork: false, PageNumberY: 116);
