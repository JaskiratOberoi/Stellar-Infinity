...
GO
/*
 * zztest01-smart-fixture-20260918.sql — a Smart Report test order on the
 ...
 *
 * One patient, one SID (ZZSMART01), twenty authorised results spread across
 ...
 * zztest01-smart-fixture-cleanup-20260918.sql.
 */
SET NOCOUNT ON;
SET XACT_ABORT ON;
...
DECLARE @sid NVARCHAR(100) = N'ZZSMART01';
DECLARE @who NVARCHAR(50) = N'inf:jas';

DECLARE @old TABLE (pid INT);
INSERT INTO @old (pid)
SELECT id FROM dbo.tbl_med_mcc_patient_master WHERE mcc_code = @mcc AND name = N'ZZ TEST SMART V2';
...
VALUES (N'ZZ TEST SMART V2', @mcc, 2, 42, 1, GETDATE(), @who);
...
FROM (VALUES
    (233, N'HE011', N'Hemoglobin', N'16.0', N'g/dL', N'12.0 - 15.0', 1),
    ...
    (104, N'BI079', N'Cholesterol - Total', N'244', N'mg/dL', N'Desirable < 200', 1),
    (102, N'BI077', N'Cholesterol - HDL', N'58', N'mg/dL', N'> 40', 0),
    (103, N'BI078', N'Cholesterol - LDL', N'162', N'mg/dL', N'Optimal < 100', 1),
    (168, N'BI218', N'Triglycerides', N'132', N'mg/dL', N'Normal < 150', 0),
    (291, N'BI127', N'Glycated Hemoglobin (HBA1c)', N'5.4', N'%', N'4.0 - 5.6', 0),
    (284, N'BI114', N'Glucose - Fasting', N'92', N'mg/dL', N'74 - 110', 0),
    (@sgpt, @sgptCode, N'Alanine amino Transferase - (ALT / SGPT)', N'62', N'U/L', N'< 45', 1),
    ...
    (114, N'BI089', N'Creatinine', N'0.8', N'mg/dL', N'0.6 - 1.1', 0),
    (172, N'BI224', N'Urea', N'26', N'mg/dL', N'15 - 40', 0),
    (170, N'BI221', N'Thyroid Stimulating Hormone (TSH)', N'6.20', N'uIU/ml', N'0.35 - 5.50', 1),
    (175, N'BI235', N'Vitamin B12', N'145', N'pg/ml', N'180 - 914', 1),
    (74, N'BI005', N'VITAMIN D', N'38', N'ng/mL', N'30 - 100', 0),
    (34, N'CP004', N'Urine pH', N'6.0', N'', N'4.5 - 8.0', 0),
    (113, N'MS024', N'C-Reactive Protein (CRP)', N'3.1', N'mg/L', N'< 5', 0),
